...
document.addEventListener('DOMContentLoaded', function() {
    ...
    createRideForm.addEventListener('submit', function(e) {
      ...
      const newRide = {
        ...
        creatorName: "Rahul Kr Gaur",  // Hardcoded for demo
        creatorInitial: "RK",
